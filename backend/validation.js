...
function validateProductPayload(body) {
  // low_stock_threshold is informational only and must be a non-negative number.
  validateRequiredFields(body, ['product_name', 'category', 'unit', 'default_unit_price', 'currency', 'low_stock_threshold']);
  ...
  validateNonNegativeNumberField(body.low_stock_threshold, 'low_stock_threshold');
}
...
function validateProductUpdatePayload(body) {
  ...
  if (body.low_stock_threshold !== undefined) validateNonNegativeNumberField(body.low_stock_threshold, 'low_stock_threshold');
...
function validateAppUserPayload(body) {
  validateRequiredFields(body, ['user_id', 'email', 'phone', 'name', 'role', 'status', 'created_by', 'updated_by']);
